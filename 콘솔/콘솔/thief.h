...
public:
    thief(const string& n, int a, int b, int c, int d ,shop& g, int dart, int wh, int bl, int f)
        : unit(n, a, b, c, d ,g, f), dart1(dart), white_position(wh), blue_position(bl),
        red_position1(0), orange_position1(0), grape_juice(0) {}
    ...
    void Setweapon(int d) override { dart1 = d; }
    int Getweapon() const override { return dart1; }
    ...
    void Skill(unit& target) override {
        ...
        cout << "스킬 데미지는 " << skillDamage << "만큼 받았습니다. "
            << "적 채력은 " << target.Gethealth() - skillDamage << " 남았습니다.\n";
